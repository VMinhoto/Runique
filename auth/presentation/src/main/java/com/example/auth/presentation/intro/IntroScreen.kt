...
/*
    Composable to old the viewmodel and navcontrol instances in order for the other composable
    functions to be isolated and testable. This compose function calls the others.

    On modular apps, we don't want to pass our navcontroller from features. ON modular apps. we
    provide lambdas
 */
@Composable
fun IntroScreenRoot(
